...
Result Explained
The Result of the corr() method is a table with a lot of numbers that represents how well 
...
0.9 is also a good relationship, and if you increase one value, the other will probably increase 
as well.
...
'''
# In simple  words it tell how much they are related 1 is for direct propotionality and 
# -1 shows indirect propotionality . 


# If the corelation is e.g 0.0048  then it means this relation will not help in any  kind of 
# prediction as both data are not much related 
